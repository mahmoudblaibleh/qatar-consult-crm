...
const AddCustomer: React.FC<AddCustomerProps> = ({ onBack, onSave }) => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            setSuccessMessage('خطأ في حفظ بيانات العميل');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <Box sx={{ width: '100%' }}>
            <Breadcrumbs sx={{ mb: 3 }}>
                ...
                <Typography color="text.primary">إضافة عميل جديد</Typography>
            </Breadcrumbs>
